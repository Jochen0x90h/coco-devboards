...
constexpr auto SYS_CLOCK = 168MHz;
...
constexpr auto LPUART1_CLOCK = APB1_CLOCK;

constexpr auto SPI1_CLOCK = APB2_CLOCK;
constexpr auto SPI2_CLOCK = APB1_CLOCK;
constexpr auto SPI3_CLOCK = APB1_CLOCK;
...
constexpr int FLASH_SIZE = 0x80000; // 512k
