...
constexpr auto SYS_CLOCK = 40MHz;
constexpr auto AHB_CLOCK = SYS_CLOCK;

constexpr auto APB1_CLOCK = AHB_CLOCK / 2; // 20MHz
constexpr auto APB1_TIMER_CLOCK = APB1_CLOCK * 2; // 40MHz

constexpr auto APB2_CLOCK = APB1_CLOCK / 2; // 20MHz
constexpr auto APB2_TIMER_CLOCK = APB1_TIMER_CLOCK * 2; // 40MHz
...
constexpr int FLASH_SIZE = 0x10000; // 64K
